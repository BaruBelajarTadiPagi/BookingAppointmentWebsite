...
class PresenceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('presence.index')->with('success', 'Kegiatan berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('presence.index')->with('success', 'Kegiatan berhasil diperbarui.');
    }
    ...
    {
        Presence::destroy($id);
        return redirect()->route('presence.index')->with('success', 'Kegiatan berhasil dihapus.');
    }
}
